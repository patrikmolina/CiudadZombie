...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 70, 150, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 95, 150, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 95, 125, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 125, 125, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 155, 125, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 155, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 155, 460, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 305, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 305, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 305, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 100, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 130, 430, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 300, 225, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 185, 195, 15, 30, 1),
    new Obstaculo('imagenes/bache.png', 130, 300, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 450, 300, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 500, 250, 30, 15, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 800, 250, 30, 15, 1),
  ...
  enemigos: [
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 1, 1, 'h'),
      new ZombieConductor('imagenes/tren_horizontal.png', 644, 0, 30, 90, 1, 'v'),
      new ZombieConductor('imagenes/tren_horizontal.png', 678, 0, 30, 90, 1, 'v'),
      new ZombieCaminante('imagenes/zombie1.png', 800, 360, 10, 10, 10, 10)
  ]
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    this.jugador.movimientoSensual(movX, movY);
    Dibujante.dibujarJugador(this.jugador, movX, movY);
  }
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo('white', 759, 555, 128, 10);
  Dibujante.dibujarRectangulo('black', 759, 545, 128, 10);
  Dibujante.dibujarRectangulo('white', 759, 535, 128, 10);
  Dibujante.dibujarRectangulo('black', 759, 525, 128, 10);
  Dibujante.dibujarTexto('LLEGADA', 'red', 800, 545);

  // El dibujante dibuja las vidas del jugador
//   var tamanio = this.anchoCanvas / this.vidasInicial/2;
//   Dibujante.dibujarRectangulo('white', 0, 0, this.anchoCanvas, 8);
//   for (var i = 0; i < this.jugador.vidas; i++) {
//     var x = tamanio * i
//     Dibujante.dibujarRectangulo('red', x, 0, tamanio, 8);
//   }
Dibujante.dibujarRectangulo('black', 45, 0, this.jugador.vidas/5*125, 35);
for (var i = 0; i < this.jugador.vidas; i++){
  var x = 25*i+50;
  Dibujante.dibujarImagen('imagenes/auto_rojo_abajo.png', x, 0, 15, 30);
};
